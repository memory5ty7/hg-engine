        ...
        case 2:
            if (!(ctx->battlemon[1].message_flag & 3)) {
                ...
                if (aliveMons == 1 && TrainerMessageWithIdPairExists(trainerIndex, 15, 5)) {
                    ...
                    switch (trainerClass) {
                    case TRAINERCLASS_WHITNEY:
                    case TRAINERCLASS_RILEY:
                    case TRAINERCLASS_GARDENIA:
                    case TRAINERCLASS_BEDE:
                    case TRAINERCLASS_OLIVIA:
                    case TRAINERCLASS_ZINNIA:
                    case TRAINERCLASS_WALLACE:
                    case TRAINERCLASS_BENGA:
                    case TRAINERCLASS_SADA:
                    case TRAINERCLASS_LEON:
                    case TRAINERCLASS_DIANTHA:
                    case TRAINERCLASS_TURO:
                    case TRAINERCLASS_STEVEN:
                        finalMonMusic = TRUE;
                        break;
                    default:
                        break;
