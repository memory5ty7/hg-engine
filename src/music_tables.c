...
u16 MainMusicComboTable[][2] =
{
    ...
    [ANIM_MUSIC_COMBO_LANCE] = {0x21, SEQ_GS_VS_SHIRONA},
    ...
    [ANIM_MUSIC_COMBO_ROMHACKER_TAG] = {0x26, SEQ_VS_ALDER},
};
...
u8 TrainerClassToMusicCombo[][2] =
{
    ...
    // (***END OF VANILLA ENTRIES***)
    {TRAINERCLASS_MEMORY5TY7, ANIM_MUSIC_COMBO_ROMHACKER_TAG*4},
    {TRAINERCLASS_MAGNATIX, ANIM_MUSIC_COMBO_ROMHACKER_TAG*4},  
};
