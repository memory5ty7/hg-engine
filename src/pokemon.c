...
BOOL CanUseItemOnMonInParty(struct Party *party, u16 itemID, s32 partyIdx, s32 moveIdx, u32 heapID) {
    ...
    {
        if (currentLevel < 100 && (itemID == ITEM_RARE_CANDY || itemID == ITEM_INFINITE_CANDY))
        {
            return TRUE;
        }
    }
...
BOOL LONG_CALL GiveMon(int heapId, void *saveData, int species, int level, int forme, u8 ability, u16 heldItem, int ball, int encounterType) {
    ...
    int maxedStats[] = {0, 0, 0};
    int maxedStat = 31;

    while (maxedStats[2] == 0)
    {
        int stat = gf_rand() % 6 + MON_DATA_HP_IV;
        ...
        for (i = 0; i < 3; i++)
        {
            ...
            {
                maxedStats[i] = stat;
                SetMonData(pokemon, stat, &maxedStat);
            }

            if (maxedStats[i] == stat) break;
        }
...
const u8 sTrainerGenders[] = {
    [TRAINERCLASS_NONE] = TRAINER_MALE,
    [TRAINERCLASS_OAK] = TRAINER_MALE,
    [TRAINERCLASS_BIANCA] = TRAINER_FEMALE,
    [TRAINERCLASS_TIERNO] = TRAINER_MALE,
    [TRAINERCLASS_WALLY] = TRAINER_MALE,
    [TRAINERCLASS_TCHEREN] = TRAINER_MALE,
    [TRAINERCLASS_LILLIE] = TRAINER_FEMALE,
    [TRAINERCLASS_MILO] = TRAINER_MALE,
    [TRAINERCLASS_ILIMA] = TRAINER_MALE,
    [TRAINERCLASS_LISIA] = TRAINER_FEMALE,
    [TRAINERCLASS_VIOLA] = TRAINER_FEMALE,
    [TRAINERCLASS_BARRY] = TRAINER_MALE,
    [TRAINERCLASS_ERIKA] = TRAINER_FEMALE,
    [TRAINERCLASS_TULIP] = TRAINER_FEMALE,
    [TRAINERCLASS_MALLOW] = TRAINER_FEMALE,
    [TRAINERCLASS_BROCK] = TRAINER_MALE,
    [TRAINERCLASS_WHITNEY] = TRAINER_FEMALE,
    [TRAINERCLASS_BEA] = TRAINER_FEMALE,
    [TRAINERCLASS_NANU] = TRAINER_MALE,
    [TRAINERCLASS_FLANNERY] = TRAINER_FEMALE,
    [TRAINERCLASS_ROXIE] = TRAINER_FEMALE,
    [TRAINERCLASS_SURGE] = TRAINER_MALE,
    [TRAINERCLASS_ROARK] = TRAINER_MALE,
    [TRAINERCLASS_BYRON] = TRAINER_MALE,
    [TRAINERCLASS_ALLISTER] = TRAINER_MALE,
    [TRAINERCLASS_BRYCEN] = TRAINER_MALE,
    [TRAINERCLASS_RILEY] = TRAINER_MALE,
    [TRAINERCLASS_CHUCK] = TRAINER_MALE,
    [TRAINERCLASS_ELESA] = TRAINER_FEMALE,
    [TRAINERCLASS_FANTINA] = TRAINER_FEMALE,
    [TRAINERCLASS_CHERYL] = TRAINER_FEMALE,
    [TRAINERCLASS_KABU] = TRAINER_MALE,
    [TRAINERCLASS_BURGH] = TRAINER_MALE,
    [TRAINERCLASS_BRASSIUS] = TRAINER_MALE,
    [TRAINERCLASS_JANINE] = TRAINER_FEMALE,
    [TRAINERCLASS_BUGSY] = TRAINER_MALE,
    [TRAINERCLASS_GARDENIA] = TRAINER_FEMALE,
    [TRAINERCLASS_OPAL] = TRAINER_FEMALE,
    [TRAINERCLASS_JASMINE] = TRAINER_FEMALE,
    [TRAINERCLASS_VALERIE] = TRAINER_FEMALE,
    [TRAINERCLASS_LIZA] = TRAINER_DOUBLE,
    [TRAINERCLASS_KORRINA] = TRAINER_FEMALE,
    [TRAINERCLASS_OLYMPIA] = TRAINER_FEMALE,
    [TRAINERCLASS_MARSHAL] = TRAINER_MALE,
    [TRAINERCLASS_NORMAN] = TRAINER_MALE,
    [TRAINERCLASS_SABRINA] = TRAINER_FEMALE,
    [TRAINERCLASS_PALMER] = TRAINER_MALE,
    [TRAINERCLASS_BEDE] = TRAINER_MALE,
    [TRAINERCLASS_POPPY] = TRAINER_MALE,
    [TRAINERCLASS_BRANDON] = TRAINER_FEMALE,
    [TRAINERCLASS_RIKA] = TRAINER_FEMALE,
    [TRAINERCLASS_ROXANNE] = TRAINER_FEMALE,
    [TRAINERCLASS_LENORA] = TRAINER_FEMALE,
    [TRAINERCLASS_MOLAYNE] = TRAINER_MALE,
    [TRAINERCLASS_AARUNE] = TRAINER_MALE,
    [TRAINERCLASS_DRASNA] = TRAINER_FEMALE,
    [TRAINERCLASS_AARON] = TRAINER_MALE,
    [TRAINERCLASS_ACEROLA] = TRAINER_FEMALE,
    [TRAINERCLASS_OLIVIA] = TRAINER_FEMALE,
    [TRAINERCLASS_MARNIE] = TRAINER_FEMALE,
    [TRAINERCLASS_LARRY] = TRAINER_MALE,
    [TRAINERCLASS_NOLAND] = TRAINER_MALE,
    [TRAINERCLASS_CANDICE] = TRAINER_FEMALE,
    [TRAINERCLASS_CAITLIN] = TRAINER_FEMALE,
    [TRAINERCLASS_GRUSHA] = TRAINER_MALE,
    [TRAINERCLASS_BURNET] = TRAINER_FEMALE,
    [TRAINERCLASS_KOGA] = TRAINER_MALE,
    [TRAINERCLASS_SPENSER] = TRAINER_MALE,
    [TRAINERCLASS_WINONA] = TRAINER_FEMALE,
    [TRAINERCLASS_ZINNIA] = TRAINER_FEMALE,
    [TRAINERCLASS_PHOEBE] = TRAINER_FEMALE,
    [TRAINERCLASS_JUAN] = TRAINER_MALE,
    [TRAINERCLASS_MISTY] = TRAINER_FEMALE,
    [TRAINERCLASS_NESSA] = TRAINER_FEMALE,
    [TRAINERCLASS_GUZMA] = TRAINER_MALE,
    [TRAINERCLASS_LORELEI] = TRAINER_FEMALE,
    [TRAINERCLASS_MARLON] = TRAINER_MALE,
    [TRAINERCLASS_CLAIR] = TRAINER_FEMALE,
    [TRAINERCLASS_SIEBOLD] = TRAINER_MALE,
    [TRAINERCLASS_CLEMONT] = TRAINER_MALE,
    [TRAINERCLASS_HAU] = TRAINER_MALE,
    [TRAINERCLASS_VOLKNER] = TRAINER_MALE,
    [TRAINERCLASS_WALLACE] = TRAINER_MALE,
    [TRAINERCLASS_BERTHA] = TRAINER_FEMALE,
    [TRAINERCLASS_AGATHA] = TRAINER_FEMALE,
    [TRAINERCLASS_BLAINE] = TRAINER_MALE,
    [TRAINERCLASS_BUCK] = TRAINER_MALE,
    [TRAINERCLASS_KIAWE] = TRAINER_MALE,
    [TRAINERCLASS_RAIHAN] = TRAINER_MALE,
    [TRAINERCLASS_MALVA] = TRAINER_FEMALE,
    [TRAINERCLASS_GREEN] = TRAINER_FEMALE,
    [TRAINERCLASS_KAREN] = TRAINER_FEMALE,
    [TRAINERCLASS_FLINT] = TRAINER_MALE,
    [TRAINERCLASS_GIOVANNI] = TRAINER_MALE,
    [TRAINERCLASS_N] = TRAINER_MALE,
    [TRAINERCLASS_BENGA] = TRAINER_MALE,
    [TRAINERCLASS_SADA] = TRAINER_FEMALE,
    [TRAINERCLASS_LEON] = TRAINER_MALE,
    [TRAINERCLASS_DIANTHA] = TRAINER_FEMALE,
    [TRAINERCLASS_TURO] = TRAINER_MALE,
