...
const u8 sTrainerGenders[] = {
    ...
    */
    ...
    // Inazuma DS Trainer Classes
    [TRAINERCLASS_MARK_EVANS]           = TRAINER_MALE,
    [TRAINERCLASS_AXEL_BLAZE]           = TRAINER_MALE,
    [TRAINERCLASS_NATHAN_SWIFT]         = TRAINER_MALE,
    [TRAINERCLASS_JACK_WALLSIDE]        = TRAINER_MALE,
    [TRAINERCLASS_KEVIN_DRAGONFLY]      = TRAINER_MALE,
    [TRAINERCLASS_TOD_IRONSIDE]         = TRAINER_MALE,
    [TRAINERCLASS_ERIK_EAGLE]           = TRAINER_MALE,
    [TRAINERCLASS_BOBBY_SHAERER]        = TRAINER_MALE,
    [TRAINERCLASS_STEVE_GRIM]           = TRAINER_MALE,
    [TRAINERCLASS_WILLIAM_GLASS]        = TRAINER_MALE,
    [TRAINERCLASS_MAXWELL_CARSON]       = TRAINER_MALE,
    [TRAINERCLASS_TIM_SAUNDERS]         = TRAINER_MALE,
    [TRAINERCLASS_SAM_KINCAID]          = TRAINER_MALE,
    [TRAINERCLASS_JIM_WRAITH]           = TRAINER_MALE,
    [TRAINERCLASS_SILVIA_WOODS]         = TRAINER_FEMALE,
    [TRAINERCLASS_NELLY_RAIMON]         = TRAINER_FEMALE,
    [TRAINERCLASS_CELIA_HILLS]          = TRAINER_FEMALE,
    [TRAINERCLASS_JUDE_SHARP]           = TRAINER_MALE,
    [TRAINERCLASS_JUDE_SHARP_RAIMON]    = TRAINER_MALE,
    [TRAINERCLASS_DAVID_SAMFORD]        = TRAINER_MALE,
    [TRAINERCLASS_JOSEPH_KING]          = TRAINER_MALE,
    [TRAINERCLASS_ROYAL_ACADEMY]        = TRAINER_MALE,
    [TRAINERCLASS_MADDIE_MOONLIGHT]     = TRAINER_FEMALE,
    [TRAINERCLASS_INAZUMA_KFT]          = TRAINER_MALE,
    [TRAINERCLASS_JOHAN_TASSMAN]        = TRAINER_MALE,
    [TRAINERCLASS_OCCULT]               = TRAINER_MALE,
    [TRAINERCLASS_LOU_EDMONDS]          = TRAINER_MALE,
    [TRAINERCLASS_UMBRELLA]             = TRAINER_MALE,
    [TRAINERCLASS_HUGO_TALLGEASE]       = TRAINER_MALE,
    [TRAINERCLASS_WILD]                 = TRAINER_MALE,
    [TRAINERCLASS_INABIKARI]            = TRAINER_MALE,
    [TRAINERCLASS_THOMAS_FELDT]         = TRAINER_MALE,
    [TRAINERCLASS_NEIL_TURNER]          = TRAINER_MALE,
    [TRAINERCLASS_BRAINWASHING]         = TRAINER_MALE,
    [TRAINERCLASS_SAMANTHA_MOONLIGHT]   = TRAINER_FEMALE,
    [TRAINERCLASS_STREET_SALLYS]        = TRAINER_FEMALE,
    [TRAINERCLASS_MARK_GAMBLING]        = TRAINER_MALE,
    [TRAINERCLASS_OTAKU]                = TRAINER_MALE,
    [TRAINERCLASS_SEYMOUR_HILLMAN]      = TRAINER_MALE,
    [TRAINERCLASS_OLD_INAZUMA]          = TRAINER_MALE,
    [TRAINERCLASS_SAIL_BLUESEA]         = TRAINER_MALE,
    [TRAINERCLASS_SHURIKEN]             = TRAINER_MALE,
    [TRAINERCLASS_MARK_HILLVALLEY]      = TRAINER_MALE,
    [TRAINERCLASS_FARM]                 = TRAINER_MALE,
    [TRAINERCLASS_THOMAS_MURDOCK]       = TRAINER_MALE,
    [TRAINERCLASS_TYLER_MURDOCK]        = TRAINER_MALE,
    [TRAINERCLASS_MALCOLM_NIGHT]        = TRAINER_MALE,
    [TRAINERCLASS_KIRKWOOD]             = TRAINER_MALE,
    [TRAINERCLASS_BYRON_LOVE]           = TRAINER_MALE,
    [TRAINERCLASS_ZEUS]                 = TRAINER_MALE,
    [TRAINERCLASS_PAUL_PEABODY]         = TRAINER_MALE,
    [TRAINERCLASS_SHADOW_CIMMERIAN]     = TRAINER_MALE,
    [TRAINERCLASS_CHESTER_HORSE_JR]     = TRAINER_MALE,
    [TRAINERCLASS_BLACK_SUIT]           = TRAINER_MALE,
    [TRAINERCLASS_INFIELDER]            = TRAINER_MALE,
    [TRAINERCLASS_BLACK_BELT]           = TRAINER_MALE,
    [TRAINERCLASS_JOGGER]               = TRAINER_MALE,
    [TRAINERCLASS_BAKER]                = TRAINER_MALE,
    [TRAINERCLASS_CYCLIST]              = TRAINER_MALE,
    [TRAINERCLASS_CLERK]                = TRAINER_MALE,
    [TRAINERCLASS_MUSICIAN]             = TRAINER_MALE,
    [TRAINERCLASS_NURSE]                = TRAINER_FEMALE,
    [TRAINERCLASS_ROUGHNECK]            = TRAINER_MALE,
    [TRAINERCLASS_WAITRESS]             = TRAINER_FEMALE,
    [TRAINERCLASS_SOCIALITE]            = TRAINER_FEMALE,
    [TRAINERCLASS_SWIMMER]              = TRAINER_MALE,
    [TRAINERCLASS_FISHERMAN]            = TRAINER_MALE,
    [TRAINERCLASS_POLICEMAN]            = TRAINER_MALE,
    [TRAINERCLASS_LINEBACKER]           = TRAINER_MALE,
    [TRAINERCLASS_BACKER]               = TRAINER_MALE,
    [TRAINERCLASS_SMASHER]              = TRAINER_MALE,
    [TRAINERCLASS_HOOPSTER]             = TRAINER_MALE
};
#else
