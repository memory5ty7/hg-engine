...
struct TrainerMoney PrizeMoney[] = // 0x34C04 in Overlay 12; 2 bytes for trainer class ID, 2 bytes for modifier; 516 bytes in total in vanilla
    {
        ...
        { .class = TRAINERCLASS_MARK_EVANS,          .multiplier = 0 },
        { .class = TRAINERCLASS_AXEL_BLAZE,          .multiplier = 50 },
        { .class = TRAINERCLASS_NATHAN_SWIFT,        .multiplier = 15 },
        { .class = TRAINERCLASS_JACK_WALLSIDE,       .multiplier = 15 },
        { .class = TRAINERCLASS_KEVIN_DRAGONFLY,     .multiplier = 15 },
        { .class = TRAINERCLASS_TOD_IRONSIDE,        .multiplier = 15 },
        { .class = TRAINERCLASS_ERIK_EAGLE,          .multiplier = 15 },
        { .class = TRAINERCLASS_BOBBY_SHAERER,       .multiplier = 15 },
        { .class = TRAINERCLASS_STEVE_GRIM,          .multiplier = 15 },
        { .class = TRAINERCLASS_WILLIAM_GLASS,       .multiplier = 15 },
        { .class = TRAINERCLASS_MAXWELL_CARSON,     .multiplier = 15 },
        { .class = TRAINERCLASS_TIM_SAUNDERS,       .multiplier = 15 },
        { .class = TRAINERCLASS_SAM_KINCAID,        .multiplier = 15 },
        { .class = TRAINERCLASS_JIM_WRAITH,         .multiplier = 15 },
        { .class = TRAINERCLASS_SILVIA_WOODS,       .multiplier = 50 },
        { .class = TRAINERCLASS_NELLY_RAIMON,       .multiplier = 50 },
        { .class = TRAINERCLASS_CELIA_HILLS,        .multiplier = 50 },
        { .class = TRAINERCLASS_JUDE_SHARP,         .multiplier = 50 },
        { .class = TRAINERCLASS_JUDE_SHARP_RAIMON,  .multiplier = 50 },
        { .class = TRAINERCLASS_DAVID_SAMFORD,      .multiplier = 30 },
        { .class = TRAINERCLASS_JOSEPH_KING,        .multiplier = 30 },
        { .class = TRAINERCLASS_ROYAL_ACADEMY,      .multiplier = 20 },
        { .class = TRAINERCLASS_MADDIE_MOONLIGHT,   .multiplier = 10 },
        { .class = TRAINERCLASS_INAZUMA_KFT,        .multiplier = 4 },
        { .class = TRAINERCLASS_JOHAN_TASSMAN,      .multiplier = 30 },
        { .class = TRAINERCLASS_OCCULT,             .multiplier = 15 },
        { .class = TRAINERCLASS_LOU_EDMONDS,        .multiplier = 10 },
        { .class = TRAINERCLASS_UMBRELLA,           .multiplier = 4 },
        { .class = TRAINERCLASS_HUGO_TALLGEASE,     .multiplier = 30 },
        { .class = TRAINERCLASS_WILD,               .multiplier = 15 },
        { .class = TRAINERCLASS_INABIKARI,          .multiplier = 0 },
        { .class = TRAINERCLASS_THOMAS_FELDT,       .multiplier = 30 },
        { .class = TRAINERCLASS_NEIL_TURNER,        .multiplier = 20 },
        { .class = TRAINERCLASS_BRAINWASHING,       .multiplier = 15 },
        { .class = TRAINERCLASS_SAMANTHA_MOONLIGHT, .multiplier = 30 },
        { .class = TRAINERCLASS_STREET_SALLYS,      .multiplier = 20 },
        { .class = TRAINERCLASS_MARK_GAMBLING,      .multiplier = 30 },
        { .class = TRAINERCLASS_OTAKU,              .multiplier = 15 },
        { .class = TRAINERCLASS_SEYMOUR_HILLMAN,    .multiplier = 50 },
        { .class = TRAINERCLASS_OLD_INAZUMA,        .multiplier = 20 },
        { .class = TRAINERCLASS_SAIL_BLUESEA,       .multiplier = 30 },
        { .class = TRAINERCLASS_SHURIKEN,           .multiplier = 15 },
        { .class = TRAINERCLASS_MARK_HILLVALLEY,    .multiplier = 30 },
        { .class = TRAINERCLASS_FARM,               .multiplier = 15 },
        { .class = TRAINERCLASS_MARVIN_MURDOCK,     .multiplier = 30 },
        { .class = TRAINERCLASS_THOMAS_MURDOCK,     .multiplier = 30 },
        { .class = TRAINERCLASS_TYLER_MURDOCK,      .multiplier = 30 },
        { .class = TRAINERCLASS_MALCOLM_NIGHT,      .multiplier = 30 },
        { .class = TRAINERCLASS_KIRKWOOD,           .multiplier = 20 },
        { .class = TRAINERCLASS_BYRON_LOVE,         .multiplier = 50 },
        { .class = TRAINERCLASS_ZEUS,               .multiplier = 30 },
        { .class = TRAINERCLASS_PAUL_PEABODY,       .multiplier = 15 },
        { .class = TRAINERCLASS_SHADOW_CIMMERIAN,   .multiplier = 15 },
        { .class = TRAINERCLASS_CHESTER_HORSE_JR,   .multiplier = 15 },
        { .class = TRAINERCLASS_BLACK_SUIT,         .multiplier = 30 },
        { .class = TRAINERCLASS_INFIELDER,          .multiplier = 10 },
        { .class = TRAINERCLASS_BLACK_BELT,         .multiplier = 10 },
        { .class = TRAINERCLASS_JOGGER,             .multiplier = 10 },
        { .class = TRAINERCLASS_BAKER,              .multiplier = 15 },
        { .class = TRAINERCLASS_CYCLIST,            .multiplier = 10 },
        { .class = TRAINERCLASS_CLERK,              .multiplier = 10 },
        { .class = TRAINERCLASS_MUSICIAN,           .multiplier = 10 },
        { .class = TRAINERCLASS_NURSE,              .multiplier = 20 },
        { .class = TRAINERCLASS_ROUGHNECK,          .multiplier = 5 },
        { .class = TRAINERCLASS_WAITRESS,           .multiplier = 20 },
        { .class = TRAINERCLASS_SOCIALITE,          .multiplier = 50 },
        { .class = TRAINERCLASS_SWIMMER,            .multiplier = 10 },
        { .class = TRAINERCLASS_FISHERMAN,          .multiplier = 20 },
        { .class = TRAINERCLASS_POLICEMAN,          .multiplier = 30 },
        { .class = TRAINERCLASS_LINEBACKER,         .multiplier = 10 },
        { .class = TRAINERCLASS_BACKER,             .multiplier = 10 },
        { .class = TRAINERCLASS_SMASHER,            .multiplier = 10 },
        { .class = TRAINERCLASS_HOOPSTER,           .multiplier = 10 }
    };
